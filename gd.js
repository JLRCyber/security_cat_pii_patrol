...
(function (gdjs2) {
  var evtTools = void 0;
  (function (evtTools2) {
    var thisIsUnusedButEnsureTheNamespaceIsDeclared = true;
  ...
  gdjs2.hexNumberToRGB = function (hexNumber) {
    return {
      r: hexNumber >> 16 & 255,
      g: hexNumber >> 8 & 255,
      b: hexNumber & 255,
  ...
  gdjs2.randomWithStep = function (min, max, step) {
    if (step <= 0) return min + gdjs2.random(max - min);
  ...
  gdjs2.getObjectConstructor = function (name) {
    if (name !== void 0 && gdjs2.objectsTypes.containsKey(name)) return gdjs2.objectsTypes.get(name);
    console.warn('Object type "' + name + '" was not found.');
    return gdjs2.objectsTypes.get("");
  };
  gdjs2.getBehaviorConstructor = function (name) {
    if (name !== void 0 && gdjs2.behaviorsTypes.containsKey(name)) return gdjs2.behaviorsTypes.get(name);
  ...
  gdjs2.makeUuid = function () {
    if (typeof crypto === "undefined" || !crypto.getRandomValues) {
      var makeMathRandomUuid = function makeMathRandomUuid(a) {
